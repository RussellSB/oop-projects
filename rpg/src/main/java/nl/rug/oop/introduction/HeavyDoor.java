...
public class HeavyDoor extends Door implements HealthModifier {
    ...
    public void interact(Player player) {
        ...
        if(getN_pushes() >= MIN_PUSHES) {
            System.out.println("You pull with all your might. You slip through, slightly taking damage as it closes back behind you");
            affectHealth(player, -10);
            super.interact(player);
        } else {
            System.out.println("You pull with all your might. It opens by an inch");
