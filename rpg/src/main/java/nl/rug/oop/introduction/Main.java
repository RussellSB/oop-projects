...
public class Main {
    public static void main(String[] args) {
        ...
        Door door5_1 = new Door("a door with the back of the troll face imprinted on it. It still makes you cringe, making you look back on when memes were worse.", room3);
