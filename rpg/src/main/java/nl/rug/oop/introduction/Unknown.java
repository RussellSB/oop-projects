...
public class Unknown extends NPC{
    ...
    public void interact(Player player) {
        if(this.getMetBefore()==true){
            ...
            System.out.println("You feel a burning sensation in your leg. You hear a scream. You feel your leg melting. You arms detach. It was more than just a flesh wound.");
